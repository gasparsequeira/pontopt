...
const HIGH_NOTE_THRESHOLD = 200; // lower period = higher pitch
if (n && mod.onHighNote && n < HIGH_NOTE_THRESHOLD) {
  mod.onHighNote(ch, n, mod.channel[ch].note);
}
